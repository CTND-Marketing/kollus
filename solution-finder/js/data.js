...
// 생성 시각: 2026-06-12T03:33:46.267Z
...
const TEXTS = {
  "hero": {
    ...
    "desc": "산업·운영 방식·상황/니즈를 선택하면,<br><b>콜러스를 도입한 기업들의 유스케이스와 솔루션</b>을 바로 확인할 수 있습니다.",
    "chips": [
      "🎬 VOD 서비스",
      "📡 라이브 스트리밍",
      "⚡ VOD + LIVE",
  ...
  "step1": {
    "tag": "Step 1",
    "title": "어떤 산업에서 서비스를 운영하고 계신가요?",
    "sub": "활용 분야를 선택하시면 해당 분야에 맞는 상황이 <b>자동으로 필터링</b>됩니다."
  },
  "step2": {
    "tag": "Step 2",
