// =========================================================
// 콜러스 솔루션 파인더 데이터 — Admin 에서 자동 생성
// 생성 시각: 2026-06-18T02:11:12.960Z
// 직접 수정하지 마세요. Admin 페이지에서 편집 후 배포하세요.
// =========================================================
...
const TEXTS = {
  "hero": {
    ...
    "desc": "서비스 분야·운영 방식·상황/니즈를 선택하면,<br><b>콜러스를 도입한 기업들의 유스케이스와 솔루션</b>을 바로 확인할 수 있습니다.",
    "chips": [
      "🎬 VOD 서비스",
      "📡 라이브 스트리밍",
      "⚡ VOD + LIVE",
  ...
  "step1": {
    "tag": "Step 1",
    "title": "동영상을 도입하려는 서비스 분야는 어디인가요?",
    "sub": "분야 선택 시 관련 문의 카테고리가 <b>자동으로 필터링</b>됩니다."
  },
  "step2": {
    "tag": "Step 2",
    "title": "현재 어떤 상황이나 니즈가 있으신가요?",
    "sub": "운영 방식 탭을 먼저 선택하고, 상황을 골라주세요. <b>복수 선택 가능</b>합니다.",
    "tabs": {
      "vod": {
        "lb": "VOD",
        "sl": "녹화·다시보기 영상"
  ...
  "step3": {
    "tag": "Step 3",
    "title": "선택하신 조건에 맞는 솔루션입니다",
    "sub": "카드를 클릭하면 자세한 내용과 주요 기능을 확인할 수 있습니다.",
    "headline": "담당자님을 위한 동영상 솔루션 매칭 결과가 나왔어요!"
  },
  "inquiry": {
    "title": "관심 있는 솔루션을 발견하셨나요?<br>견적과 도입 상담을 신청해 보세요.",
    "sub": "선택하신 조건이 자동으로 정리됩니다. 아래 내용을 복사해서 <b>문의 내용</b>란에 붙여넣어 주세요."
  },
  "footer": {
    "txt": "국내 No.1 동영상 플랫폼 콜러스"
  }
};
...
const UC = [
  ...
  },
  {
    ...
    "situation": "핸드폰으로 편리하고 즉시 라이브 방송을 선호하는 중·소상공인. 대기업은 D2C 자사몰 API 연동 턴키 필요.",
    "position": "핸드폰으로 즉시 시작하는 중·소상공인 라이브부터 대기업 D2C 자사몰 완전 연동까지",
    "customers": "노랑풍선"
  },
  {
    "id": "uc18",
    ...
    "position": "상품 영상 하나가 구매 전환율을 높인다. 짧은 영상부터 고화질 상품 영상까지, 노코드로 솔루션으로 운영 부담 제로",
    "customers": "신성통상, 아난티"
  },
  {
    "id": "uc19",
...
// ── 텍스트 자동 적용 (솔루션 파인더 페이지에서만 동작, index 파일 수정 불필요) ──
...
(function(){function boot(){if(typeof document==="undefined")return;if(!document.querySelector(".hero"))return;try{applyTexts(document, TEXTS);}catch(e){}}if(typeof document!=="undefined"){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",boot);}else{boot();}}})();
